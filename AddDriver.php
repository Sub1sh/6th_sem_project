...
$result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM driver");
$row = mysqli_fetch_assoc($result);

// Reset auto-increment if no drivers exist
if($row['total'] == 0){
    mysqli_query($conn, "ALTER TABLE driver AUTO_INCREMENT = 1");
}
            ...
            <h1><b><i><center>Add a Driver...</center></i></b></h1>
                ...
                <div class="button-box"> 
                    ...
                    <form id="Register" class="input-group"  method="post">
                        ...
                        <input type="tel" name="tel" class="input-field" placeholder="977-1234567890" title="input as mention way!!!" required>
                        <input type="text" name="address"class="input-field" placeholder="Enter driver address" required>
                        <input type="number" name="amount" class="input-field" placeholder="Anticipated Amount" required>
